  ...
  render() {
    return (
      <div>
        ...
        />
                        <div className="desc">
                          <h1>Hi! <br />I'm Ilgın</h1>
                          <p><a className="btn btn-primary btn-learn" href="https://drive.google.com/file/d/1199PWRkT5jotx9jiVkYa5az8rH7Wf_cr/view?usp=sharing" target="_blank" rel="noopener noreferrer">View CV<i className="icon-download4" /></a></p>
                        </div>
                      </div>
                    </div>
                  </div>
